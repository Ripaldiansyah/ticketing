...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->isAdmin())
                    <x-nav-link :href="route('admin.whatsapp')" :active="request()->routeIs('admin.whatsapp')"
                        wire:navigate>
                        WhatsApp
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('checkin')" :active="request()->routeIs('checkin')" wire:navigate>
                        Check-In
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <!-- Role Badge -->
                <span class="px-2 py-1 text-xs font-medium rounded-full mr-3 
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->isAdmin())
            <x-responsive-nav-link :href="route('admin.whatsapp')" :active="request()->routeIs('admin.whatsapp')"
                wire:navigate>
                WhatsApp
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('checkin')" :active="request()->routeIs('checkin')" wire:navigate>
                Check-In
            </x-responsive-nav-link>
        </div>
